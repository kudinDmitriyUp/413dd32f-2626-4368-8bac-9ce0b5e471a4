...
export const metadata: Metadata = {
  title: "Scooby's Learning Lab - Fun Learning Adventures for Kids",
  description: "Join Scooby Doo on mystery-solving adventures while learning reading, math, and critical thinking skills. Educational games designed for kids ages 6-12.",
  keywords: "kids learning games, educational adventures, reading games, math learning, child education, Scooby Doo learning",
  metadataBase: new URL("https://scoobylearninglab.com"),
  alternates: {
    canonical: "https://scoobylearninglab.com"
  },
  openGraph: {
    title: "Scooby's Learning Lab - Fun Learning Adventures",
    description: "Make learning an adventure with Scooby Doo. Engaging educational games for kids.",
    type: "website",
    siteName: "Scooby's Learning Lab",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1765878759083-6b1lgz61.jpg",
      alt: "Scooby Doo Learning Adventure"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Scooby's Learning Lab",
    description: "Fun educational adventures for kids ages 6-12",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1765878759083-6b1lgz61.jpg"]
  },
  robots: {
    index: true,
    follow: true
